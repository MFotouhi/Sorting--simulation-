        ...
        
{
   ...
   ///////////////////////////////////////////  Data Size=1000
    ...
    start = clock();
    insertionSort(input_arr_1000,data_size); 
    end = clock(); 
...
//    printf( "/////////////////////////\n");
    ...
    start = clock();
    insertionSort(input_arr_10000,data_size); 
    end = clock(); 
...
//    printf( "/////////////////////////\n");
    ...
    start = clock();
    insertionSort(input_arr_20000,data_size); 
    end = clock(); 
...
//    printf( "/////////////////////////\n");
    ...
    start = clock();
    insertionSort(input_arr_30000,data_size); 
    end = clock(); 
...
//    printf( "/////////////////////////\n");
    ...
    start = clock();
    insertionSort(input_arr_50000,data_size); 
    end = clock(); 
