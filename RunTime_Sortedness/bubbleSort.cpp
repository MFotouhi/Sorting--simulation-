        ...
        
{
   ...
   ///////////////////////////////////////////  Shuffle Percent = 0
    ...
    start = clock();
    bubbleSort(input_arr_0,data_size); 
    end = clock(); 
   ...
   Shuffle_Percent =25;
    ...
    start = clock();
    bubbleSort(input_arr_25,data_size); 
    end = clock(); 
   ...
   Shuffle_Percent = 50;
    ...
    start = clock();
    bubbleSort(input_arr_50,data_size); 
    end = clock(); 
   ...
   Shuffle_Percent = 75;
    ...
    start = clock();
    bubbleSort(input_arr_75,data_size); 
    end = clock(); 
   ...
   Shuffle_Percent = 100;
    ...
    start = clock();
    bubbleSort(input_arr_100,data_size); 
    end = clock(); 
